    ...
    return(
        <header className={"h-1/5 w-full sticky top-0 z-50 bg-white"}>
            <div className={"space-x-0 flex flex-row justify-eve space-ah-10 border-b-2"}>
                <div className={"mx-2 text-black w-10/12 md:w-5/12 lg:w-7/12 xl:w-9/12 2xl:w-8/12 flex flex-row ml-10 border-r-2"}>
                    <input type={"text"} placeholder={"hola"} className={"h-full w-11/12 focus:outline-none"}/>
                    <button className={"m-3"}>buscar</button>
                </div>
                <div className={"pr-2  py-5 w-2/12 md:w-7/12 lg:w-5/12 xl:w-3/12 2xl:w-4/12   flex flex-row justify-center md:justify-evenly items-center"}>
